...
/// </summary>
public abstract class TracingService : TracingBase, ITracingService
{
	/// <inheritdoc cref="TracingService" />
		...
		bool logOnExit = true)
	{
		return LogInternal(arguments, LogLevel.Debug, method, fullFilePath, autoExit, logOnExit,
			TracingContext.OpenTelemetryOptions.CaptureCache.Components[CaptureComponent.Service]);
	}
}