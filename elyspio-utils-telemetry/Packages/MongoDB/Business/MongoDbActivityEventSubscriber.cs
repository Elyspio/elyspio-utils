...
using Elyspio.Utils.Telemetry.MongoDB.Helpers;
using Elyspio.Utils.Telemetry.MongoDB.Options;
using MongoDB.Driver.Core.Events;

namespace Elyspio.Utils.Telemetry.MongoDB.Business;

/// <summary>
///     Capture mongodb events and create activities
/// </summary>
public sealed class MongoDbActivityEventSubscriber : IEventSubscriber
{
